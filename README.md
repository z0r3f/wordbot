[![Build Status](https://dev.azure.com/ferozar/WordBot/_apis/build/status%2Fz0r3f.wordbot?branchName=refs%2Ftags%2F0.4.3)](https://dev.azure.com/ferozar/WordBot/_build/latest?definitionId=26&branchName=refs%2Ftags%2F0.4.3)
...
```
```shell
docker tag z0r3f/wordbot-docker:latest z0r3f/wordbot-docker:0.4.3
```
```shell
docker push z0r3f/wordbot-docker:latest
docker push z0r3f/wordbot-docker:0.4.3
```
